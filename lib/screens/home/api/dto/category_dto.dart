...
class CategoryFoodsDTO {
  ...
  CategoryFoodsDTO({required this.data});

  Map<String, dynamic> toJson() => _$CategoryFoodsDTOToJson(this);

  factory CategoryFoodsDTO.fromJson(Map<String, dynamic> json) =>
      _$CategoryFoodsDTOFromJson(json);
